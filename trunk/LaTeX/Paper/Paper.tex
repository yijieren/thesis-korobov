...
\end{align*}
\comm{De eerste lijn volgt uit het weglaten van $k=v-1$ uit de sommatie. De tweede lijn volgt dan uit het feit dat $h_v\le h_{v-1}$. NOTA: mijns inziens zou de gelijkheid in de eerste lijn enkel opgaan in het geval $v=n+1$}
